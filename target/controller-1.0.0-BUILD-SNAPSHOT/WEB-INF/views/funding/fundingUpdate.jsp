...
<body>
    ...
    <tr>
    	<td>제목:</td>
    	<td colspan=2><input type="text" id="goods_title" name="title" class="form-control" value = "${gvo.title } "></td>
    </tr>
	<tr>
	...
	<td>참여금액:</td>
		<td>
			<input type="text" id="price" name="price" placeholder="참여자들이 내는 금액" class="form-control" value = ${list.price }> 
		</td>
		<td><strong>원 참여 시</strong></td>
		<td>
			<input type="text"  id="wantPrice" name="product" placeholder="상품 목록" class="form-control" value = "${list.product }"> 
		</td>
	...
	<tbody id="addBtnDiv">
        ...
        <textarea name="editor" id="editor" style="height:600px;width:900px;">${gvo.content }</textarea>
    </div>
